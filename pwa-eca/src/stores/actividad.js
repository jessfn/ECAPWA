...
export const useActividadStore = defineStore('actividad', {
  ...
  actions: {
    async crear({
      ...
      subtemaId,
      sistemaProductivoId,
      tipoActividadOtroTexto,
      temaOtroTexto,
      subtemaOtroTexto,
      sistemaProductivoOtroTexto,
      descripcion,
      resultado,
      numParticipantes,
      requiereSeguimiento,
      ...
      try {
        return await encolar('outbox_actividades', {
          ...
          tipo_actividad_otro_texto: tipoActividadOtroTexto || null,
          tema_otro_texto: temaOtroTexto || null,
          subtema_otro_texto: subtemaOtroTexto || null,
          sistema_productivo_otro_texto: sistemaProductivoOtroTexto || null,
          descripcion,
          resultado,
